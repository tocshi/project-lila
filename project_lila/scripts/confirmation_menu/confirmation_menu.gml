...
confirm_menu = instance_create_layer(x, y, "GUIPopUp", obj_confirmation_menu);
confirm_menu.text = argument2;
btn_yes = instance_create_layer(x - confirm_menu.BTN_SEP, y + confirm_menu.BTN_DEPTH, "GUIPopUpButton", obj_generic_btn);

btn_no = instance_create_layer(x + confirm_menu.BTN_SEP, y + confirm_menu.BTN_DEPTH, "GUIPopUpButton", obj_generic_btn);
...
btn_yes.text = "Yes";
btn_yes.alarm[0] = 1;
btn_yes.sprite = spr_confirmation_button;
...
btn_no.text = "No";
btn_no.alarm[0] = 1;
btn_no.sprite = spr_confirmation_button;