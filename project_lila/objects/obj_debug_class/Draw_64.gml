...
for(i = 0; i < array_length_1d(skill_sprite); i++){
	...
	draw_healthbar(hpmpend+(i*80), 20, hpmpend+(i*80)+width, 20+height, (cd[i+1]/maxcd[i+1])*100, c_dkgray, c_black, c_black, 2, true, false);
	draw_text(hpmpend+(i*80)+(width/2),20+(height/4),string(ceil(cd[i+1]/60)));
	draw_set_alpha(1);
